...
source("C:/Users/degrootel/Documents/Parc Stopover/data_tools-master/functions/data_manager.R")
source("C:/Users/degrootel/Documents/Parc Stopover/data_tools-master/functions/node_health.R")
...
infile <- "C:/Users/degrootel/Documents/Parc Stopover/data/PARC Stopover/"

#This is where you want your output to go
outpath <- "C:/Users/degrootel/Documents/Parc Stopover/outpath/"
...
#tags <- c("61526633")
start_time = as.POSIXct("2021-09-15 01:00:00", tz = "America/New_York")
end_time = as.POSIXct("2021-10-01 23:00:00", tz = "America/New_York")
